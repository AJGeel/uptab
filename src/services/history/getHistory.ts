 ...
 * @TODO Other supported params: https://developer.chrome.com/docs/extensions/reference/api/history#parameters_5
 */
export const getHistory = ({ query }: GetHistoryParams) =>
  history.search({ text: query, maxResults: 1000, startTime: 0 });
